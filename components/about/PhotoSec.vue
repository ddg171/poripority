<template>
  <AboutContentSection id="photography" class="sticky top-0 z-20 min-h-screen pt-10 bg-darkblue md:pt-16" @in="isShown=true">
    <template #heading>
      <AppHeading2>
        Photography
      </AppHeading2>
    ...
    <template #default>
      <div class="flex flex-col items-start justify-center w-full text-white md:flex-row-reverse ">
