<template>
  <div v-if="isShow" class="optin py-6 px-4 md:px-12 md:max-w-2xl fixed w-full border-solid border-white bottom-0 ml-0 shadow-xl shadow-gray  opacity-100 bg-gray grid gap-2 transition-opacity  delay-600 z-40" :is-visible="isVisible">
    <div class="w-full">
